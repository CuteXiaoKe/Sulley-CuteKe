...
s_group('commands1', values=['CWD''STOR', 'STOU', 'APPE'])
...
s = sessions.session(session_filename="audit\\ftp.session")
...
'''
target.netmon  = pedrpc.client("10.59.13.191", 26001)
target.procmon = pedrpc.client("10.59.13.191", 26002)
target.procmon_options =  {
  ...
  "start_commands" : ['E:\\protocol\\ftp\\easyftp-server-1.7.0.11-en\\ftpbasicsvr.exe /nontservice'],
}
'''
